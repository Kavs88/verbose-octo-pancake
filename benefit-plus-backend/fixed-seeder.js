...
// Test data from AI - FIXED to match actual Strapi schemas
const testData = {
  businesses: [
    {
...
async function seedTestData() {
  try {
    ...
    // 3. Seed events with business relationships (using basic event schema)
...
async function seedEvents(businessIds) {
  console.log('📅 Seeding events (basic schema)...');
